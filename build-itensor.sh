...
vi options.mk
edit : 
	PLATFORM=mkl                                                                                                                                                BLAS_LAPACK_LIBFLAGS=-L$(MKLROOT)/lib/intel64 \                                                                                                                                                      -Wl,-rpath,$(MKLROOT)/lib/intel64 \                                                                                                                         -L/opt/intel/tbb/lib/intel64_lin/gcc4.7 \                                                                                                                   -Wl,-rpath,/opt/intel/tbb/lib/intel64_lin/gcc4.7 \                                                                                                          -lmkl_rt -lpthread#/opt/intel/tbb/lib/intel64_lin/gcc4.7/libtbb.so.2 /opt/intel/tbb/lib/intel64_lin/gcc4.7/libtbbmalloc.so.2 -lpthread -lm -ldl                                                                                                                                                                    
